<template>
    <company :title="__('l.Knowledge Base')" :pn="__('l.Articles List')" :pl="route('knowledge_base.index')" :current="__('l.Add Article')">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title float-left">{{ __("l.Add Article") }}</h3>
            ...
            <div class="card-body" style="min-height: 500px">
                <form id="article_save" @submit.prevent="article_save" enctype="multipart/form-data">
                    ...
                    <div class="form-group"><label><span>{{ __("l.Order") }}</span></label>
                        <input type="number" name="order" :value="count" class="form-control">
                    </div>
                    <div class="form-group">
...
export default {
    ...
    methods: {
        async group_save(e){
            ...
            this.$inertia.post(this.route('knowledge_base.save'), data, {preserveState: false})
        }
    }
}
