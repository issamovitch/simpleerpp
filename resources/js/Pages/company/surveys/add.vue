 <template>
        <company :title="__('l.Surveys')" :pn="__('l.Surveys List')" :pl="route('surveys.index')" :current="__('l.Add Survey')">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title float-left">{{ __("l.Add Survey") }}</h3>
...
export default {
    ...
    methods: {
        ...
        save_survey(){
            ...
            this.$inertia.post(this.route('surveys.save'), data, {preserveState: false})
        }
    }
}
</script>
