                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" ref="password" readonly onfocus="this.removeAttribute('readonly');" class="form-control" name="password" required>
                                                <small>{{__("l.Leave the field empty if you dont want to change password")}}</small>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <img :src="(user.image)?asset('storage/app/'+ user.image):asset('public/no-image.png')" ref="image" v-on:click="$refs.file.click()" class="image_user_add" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control" name="designation_id" id="designation_id">
                                                        <option value="">{{__("l.Choose")}}</option>
                                                        <option v-bind:selected="user.designation_id==designation.id" v-for="designation in designations" :value="designation.id">{{designation.name}}</option>
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <select name="department_id" class="form-control" id="department_id">
                                                        <option value="">{{__("l.Choose")}}</option>
                                                        <option v-bind:selected="user.department_id==department.id" v-for="department in departments" :value="department.id">{{department.name}}</option>
                                                    </select>
                                                    <div class="input-group-prepend">
                                            <span class="input-group-append">
                                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="manager_id" class="form-control">
                                                    <option value="">{{__("l.Choose")}}</option>
                                                    <option v-bind:selected="user.manager_id==usr.id" v-for="usr in users" :value="usr.id">{{usr.name}}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="workplace" class="form-control" style="height: 208px;">{{user.workplace}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-10 mx-auto">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" :value="user.phone" name="phone" autocomplete="off">
                                    </div>
                                    <div class="form-group">
                                        <label><span>{{__("l.Mobile")}}</span></label>
                                        <input type="text" class="form-control" :value="user.mobile" name="mobile" autocomplete="off">
                                    </div>
                                    <div class="form-group">
                                <label><span>{{__("l.Emergency Contact")}}</span></label>
                                <textarea class="form-control" rows="1" name="emergency_contact" autocomplete="off">{{user.emergency_contact}}</textarea>
                            </div>
                                </div>
                            </div>
                        </tab-content>
                                ...
                                <div class="col-sm-10 mx-auto">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="gender" autocomplete="off">
                                            <option value="">{{__("l.Choose")}}</option>
                                            <option value="Male" v-bind:selected="user.gender=='Male'">{{__("l.Male")}}</option>
                                            <option value="Female" v-bind:selected="user.gender=='Female'">{{__("l.Female")}}</option>
                                            <option value="Other" v-bind:selected="user.gender=='Other'">{{__("l.Other")}}</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="civil_status" autocomplete="off">
                                            <option value="">{{__("l.Choose")}}</option>
                                            <option value="Single" v-bind:selected="user.civil_status=='Single'">{{__("l.Single")}}</option>
                                            <option value="Married" v-bind:selected="user.civil_status=='Married'">{{__("l.Married")}}</option>
                                            <option value="Cohabitant" v-bind:selected="user.civil_status=='Cohabitant'">{{__("l.Cohabitant")}}</option>
                                            <option value="Widower" v-bind:selected="user.civil_status=='Widower'">{{__("l.Widower")}}</option>
                                            <option value="Divorced" v-bind:selected="user.civil_status=='Divorced'">{{__("l.Divorced")}}</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label><span>{{__("l.Number Of Children")}}</span></label>
                                        <input type="number" class="form-control" :value="user.number_of_children" name="number_of_children" autocomplete="off"/>
                                    </div>
                                </div>
                            </div>
                        </tab-content>
...
export default {
    ...
    methods: {
        ...
        save_user(){
            ...
            this.$inertia.post(this.route("users.update"), data, {preserveState: true})
        },
        designations_save(e){
